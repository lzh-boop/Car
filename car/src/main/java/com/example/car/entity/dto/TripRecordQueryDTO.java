...
@Data
@Schema(description = "行程记录查询条件")
public class TripRecordQueryDTO {
    
    @Schema(name = "车辆ID", description = "车辆ID", example = "1")
    private Long vehicleId;
    
    @Schema(name = "车牌号", description = "车牌号", example = "京A12345")
    private String vehicleNo;
    
    @Schema(name = "驾驶员ID", description = "驾驶员ID", example = "1")
    private Long driverId;
    
    @Schema(name = "驾驶员姓名", description = "驾驶员姓名", example = "张三")
    private String driverName;
    
    @Schema(name = "行程状态", description = "行程状态：1-进行中，2-已结束", example = "1")
